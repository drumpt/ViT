...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument("--layers", default=12, type=int, help="number of transformer encoder")
        self.parser.add_argument("--n_classes", default=10, type=int, help="number of classes of training data")
        self.parser.add_argument("--num_heads", default=12, type=int, help="number of heads for multi-head attention")
        self.parser.add_argument("--dropout", default=0.1, type=float, help="dropout rate")
        self.parser.add_argument("--expansion", default=4, type=int, help="expansion ratio for feedforward block")
        ...
        self.parser.add_argument('--net', type=str, default='ViT', help="model name for training")
